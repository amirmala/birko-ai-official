    ...
    <footer className="main-footer">
      <div className="footer-container">
        ...
        <div className="footer-column brand-col">
          <h2 className="footer-logo">Birko<span>Tools</span></h2>
          <p>منصتك المتكاملة لأدوات الذكاء الاصطناعي والخدمات الرقمية. سهولة، سرعة، وأمان في مكان واحد.</p>
          <div className="social-links">
            ...
            <a href="https://github.com/Amir" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
        ...
        {/* العمود الثالث: الأدوات */}
        <div className="footer-column links-col">
          <h3>Explore Tools</h3>
          <ul>
            <li><a href="#tools">AI Image Gen</a></li>
            <li><a href="#tools">WiFi QR Code</a></li>
            <li><a href="#tools">Data Analysis</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <p>&copy; {currentYear} <strong>BirkoTools</strong>. All rights reserved.</p>
      </div>
    </footer>
  );
};
